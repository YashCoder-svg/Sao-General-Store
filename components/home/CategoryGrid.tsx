...
const DISCOVERY_SECTIONS: DiscoverSection[] = [
  {
    ...
    items: [
      ...
      },
      {
        id: "masala-spices",
        label: "Masala & Spices",
        target: "masala-spices",
      },
      {
        id: "dairy-breakfast",
        label: "Dairy & Breakfast",
        target: "dairy-breakfast",
      },
      {
        id: "organic-health",
        label: "Organic & Health",
        target: "organic-health",
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        target: "biscuits-cookies",
      },
      {
        id: "noodles-ready-to-eat",
        label: "Noodles & Ready-to-Eat",
        target: "noodles-ready-to-eat",
      },
      {
        id: "chips-namkeen",
        label: "Chips & Namkeen",
